...
urlpatterns = [
    ...
    path("detail/<slug:slug>", FoodDetailView.as_view(), name="food_details"), # Maybe delete this
    ...
    path("food/<int:pk>", SessionFoodView.as_view(), name="food_session"),

    path("registered_foods/", RegisteredFoodListView.as_view(), name="registered_foods"),
